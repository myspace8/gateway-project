        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          {/* <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            ...
            <a href="#" className="text-sm font-semibold leading-6 text-gray-900">
              Cod <span aria-hidden="true">&rarr;</span>
            </a>
          </div> */}
        </nav>
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-1xl py-8 sm:py-38 lg:py-0">
          ...
          <div className="text-center mt-4">
            <h1 className="md:text-4xl text-3xl mb-3 md:hidden font-bold tracking-tight text-gray-900 sm:text-6xl">
              Discovering the World of Programming and Coding
            </h1>
            <div className="relative ">
            <h1 className="absolute bottom-0 left-[26rem] text-4xl mb-8 hidden md:block font-bold tracking-tight text-gray-900 sm:text-6xl bg-white px-4 py-2">
              Discovering the World of Programming and Coding
            </h1>
            <div className='mt-12'>
              <img
